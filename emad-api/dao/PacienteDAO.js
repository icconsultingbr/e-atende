...
// PacienteDAO.prototype.buscaPorIdSapSync = async function (idSap) {
...
//   left join tb_estabelecimento est on est.id = pac.idEstabelecimentoCadastro WHERE pac.idSap = ?`, idSap);
            ...
            conn.query(`INSERT INTO ${table} SET geom = POINT(?, ?), ?`, [paciente.longitude, paciente.latitude, paciente],
                ...
                function (error, results) {
                    ...
                    conn.query(`SELECT
                        ...
                        tp.cartaoSus,
                        'P' as tipo_cartao,
                        tp.necessidadeEspeciais,
                        tp.reeducando,
                        tp.gestante,
                        tp.aleitamentoMaterno,
                        tp.dumDaGestante,
                        tp.idadeGestacional,
                    ...
                    where tp.id = ?`, results.insertId,
                        ...
                        function (error, dadosPaciente) {
                            ...
                            connDim.query(`INSERT INTO paciente (id_status_paciente,unidade_cadastro,unidade_referida,cidade_id_cidade,nome,tipo_logradouro,
                                ...
                                nome_mae_sem_espaco,num_pasta,necessidadeEspeciais,gestante,aleitamentoMaterno,dumDaGestante,idadeGestacional,stGravidezPlanejada,nuGestasPrevias,nuPartos) VALUES (?,?,?,
                                ...
                                dadosPaciente[0].necessidadeEspeciais,
                                dadosPaciente[0].reeducando,
                                dadosPaciente[0].gestante,
                                dadosPaciente[0].aleitamentoMaterno,
                                dadosPaciente[0].dumDaGestante,
                                dadosPaciente[0].idadeGestacional,
...
PacienteDAO.prototype.buscaPorIdFicha = function (id, callback) {
    ...
    p.necessidadeEspeciais,
    p.reeducando,
    p.gestante,
    p.aleitamentoMaterno,
    DATE_FORMAT(p.dumDaGestante,'%d/%m/%Y') as dumDaGestante,
    p.idadeGestacional,

...
const DominiosRepository = UfDAO()
class DominiosExternoController{

    async listaDominios(req, res, app){
      const conn = await connection();
      const dominiosRepository = new DominiosRepository(conn);
      var response = await dominiosRepository.listaDominios(dominiosRepository, "uf", res).then(function (response) {

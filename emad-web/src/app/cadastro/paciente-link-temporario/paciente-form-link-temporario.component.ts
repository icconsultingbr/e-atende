...
@Component({
  selector: 'app-paciente-form-link-temporario',
  templateUrl: './paciente-form-link-temporario.component.html',
  styleUrls: ['./paciente-form-link-temporario.component.css'],

...
export class AtendimentoService extends GenericsService {
  ...
  saveVacina(obj: any) {
    if (obj.id) {
      return this.http.put('atendimento-vacina', JSON.stringify(obj));
    } else {
      return this.http.post('atendimento-vacina', JSON.stringify(obj));
    }
  }

  stopProcess(obj: any) {
    return this.http.put('atendimento/parar-atendimento', JSON.stringify(obj));
  }

  saveEncaminhamento(obj: any) {
    if (obj.id) {
      return this.http.put('atendimento-encaminhamento', JSON.stringify(obj));
    } else {
      return this.http.post('atendimento-encaminhamento', JSON.stringify(obj));
    }
  }
  ...
  saveParticipanteAtividadeColetiva(obj: any) {
    if (obj.id) {
      return this.http.put(
        'participante-atividade-coletiva',
        JSON.stringify(obj),
      );
    } else {
  ...
  savetiposFornecimOdonto(obj: any) {
    if (obj.id) {
      return this.http.put('tipo-odonto-atendimento', JSON.stringify(obj));
    } else {
      return this.http.post('tipo-odonto-atendimento', JSON.stringify(obj));
    }
  }

  savetiposVigilanciaSaudeBucal(obj: any) {
    if (obj.id) {
      return this.http.put('tipo-vigilancia-odonto', JSON.stringify(obj));
    } else {
      return this.http.post('tipo-vigilancia-odonto', JSON.stringify(obj));
    }
  }
  ...
  saveProfissionalAtividadeColetiva(obj: any) {
    if (obj.id) {
      return this.http.put(
        'profissional-atividade-coletiva',
        JSON.stringify(obj),
      );
    } else {
      return this.http.post(
  ...
  saveMedicamento(obj: any) {
    if (obj.id) {
      return this.http.put('atendimento-medicamento', JSON.stringify(obj));
    } else {
      return this.http.post('atendimento-medicamento', JSON.stringify(obj));
    }
  }
  ...
  atribuirAtendimento(obj: any) {
    return this.http.put(
      'atendimento/atribuir-atendimento/',
      JSON.stringify(obj),
    );
  }
  ...
  saveProcedimento(obj: any) {
    if (obj.id) {
      return this.http.put('atendimento-procedimento', JSON.stringify(obj));
    } else {
      return this.http.post('atendimento-procedimento', JSON.stringify(obj));
    }
  }
  ...
  findByDosePorEstrategiaVacina(
    codigoVacinaSus: any,
    codigoEstrategiaVacinacaoSus: any,
  ): Observable<any> {
  ...
  salvarArquivo(obj: any) {
    return this.http.post('atendimento-documento/', JSON.stringify(obj));
  }

  removeArquivoExame(obj: any) {
    return this.http.put(
      'atendimento-documento/atualiza/' + obj.id,
      JSON.stringify(obj),
    );
  }
}

...
export class ProntuarioPacienteImpressaoService extends RelatorioProntuarioPacienteService {
  ...
  constructor(private pacienteService: PacienteService, private pacienteLinkTemporarioService: PacienteLinkTemporarioService) {
    super();
      ...
      .subscribe((result) => {
        ...
        if (sinaisVitaisFilter) {
          ...
          sinaisVitaisFilter.forEach((sinais) => {
            sinaisVitais += `<tr class="text-left">
                                        <td class="text-secondary">${sinais.pressaoArterial
                ? sinais.pressaoArterial
                : ''
              }</td>
                                        <td class="text-secondary">${sinais.pulso ? sinais.pulso : ''
              }</td>
                                        <td class="text-secondary">${sinais.saturacao
                ? sinais.saturacao
                : ''
              }</td>
                                        <td class="text-secondary">${sinais.temperatura
                ? sinais.temperatura
                : ''
              }</td>
                                        <td class="text-secondary">${sinais.peso ? sinais.peso : ''
              }</td>
                                        <td class="text-secondary">${sinais.glicemia ? sinais.glicemia : ''
              }</td>
                                        <td class="text-secondary">${sinais.label ? sinais.label : ''
              }</td>
                                    </tr>`;
          });
        ...
        if (atendimentosFilter) {
          atendimentosFilter.forEach((atendimento) => {
            ...
            atendimentos += `<div class="col s12">
                                            <span> <b>ID do Atendimento</b>: ${atendimento.id
              }</span>
                                            <span> <b>Unidade</b>: ${atendimento.estabelecimentoNome
              }</span>
                                            <span> <b>Tipo de atendimento</b>: ${atendimento.fichaNome
              }</span>
                                            <span> <b>Situação atual</b>: ${atendimento.situacaoNome
              }</span>
                                            <span> <b>Motivo da queixa</b>: ${atendimento.motivoQueixa
                ? atendimento.motivoQueixa
                : ''
              }</span>
                                            <span> <b>Tipo</b>: ${atendimento.tipoHistoriaClinica
                ? tpHistoriaClinica.nome
                : ''
              }</span>
                                            <span> <b>Descrição</b>: ${atendimento.historicoClinico
          ...
          receitasFilter.forEach((receita) => {
            ...
            receita.itensReceita.forEach((itens) => {
              itensReceita += `<tr class="text-left">
                                                <td class="text-secondary">${itens.codigoMaterial
                }</td>
                                                <td class="text-secondary">${itens.nomeMaterial
                }</td>
                                                <td class="text-secondary">${itens.qtdPrescrita
                }</td>
                                                <td class="text-secondary">${itens.tempoTratamento
                }</td>
                                                <td class="text-secondary">${itens.qtdDispAnterior
                }</td>
                                                <td class="text-secondary">${itens.dataUltDisp
                  ? _moment(
                    itens.dataUltDisp,
                  ).format(
                    'DD/MM/YYYY HH:mm',
                  ...
                  : ''
                                                ...
                                                <td class="text-secondary">${itens.observacao
                  ? itens.observacao
                  : ''
                }</td>
                                            </tr>`;
            ...
            receitas += `<div class="col s12">
                                        <span> <b>Estabelecimento</b>: ${receita.nomeEstabelecimento
              }</span>
                                        <span> <b>Profissional</b>: ${receita.nomeProfissional
              }</span>
                                        <span> <b>Ano</b>: ${receita.ano}</span>
                                        <span> <b>Número</b>: ${receita.numero
              }</span>
                                        <span> <b>Situação</b>: ${receita.situacaoNome
              }</span>
                                        <span> <b>Data emissão</b>: ${receita.dataEmissao
                ? _moment(
                  receita.dataEmissao,
        ...
        if (fichasAtendimentoFilter) {
          ...
          fichasAtendimentoFilter.forEach((ficha) => {
            fichasAtendimento += `<tr class="text-left">
                                                <td class="text-secondary">${ficha.id
              }</td>
                                                <td class="text-secondary">${ficha.fichaNome
              }</td>
                                                <td class="text-secondary">${ficha.classificacaoNome
              }</td>
                                                <td class="text-secondary">${ficha.motivoQueixa
                ? ficha.motivoQueixa
                : ''
              }</td>
                                                <td class="text-secondary">${ficha.situacaoNome
              }</td>
                                                <td class="text-secondary">${ficha.dataCriacao
                ? _moment(
                  ficha.dataCriacao,
                ).format(
                  'DD/MM/YYYY HH:mm',
                ...
                : ''
                                                ...
                                                <td class="text-secondary">${ficha.estabelecimentoNome
              }</td>
                                            </tr>`;
          });
        ...
        if (examesFilter) {
          ...
          examesFilter.forEach((exame) => {
            exames += `<tr class="text-left">
                                        <td class="text-secondary">${exame.id
              }</td>
                                        <td class="text-secondary">${exame.nomeTipoExame
              }</td>
                                        <td class="text-secondary">${exame.nomeProfissional
              }</td>
                                        <td class="text-secondary">${exame.situacaoNome
              }</td>
                                        <td class="text-secondary">${exame.resultadoNome
              }</td>
                                        <td class="text-secondary">${exame.dataCriacao
                ? _moment(exame.dataCriacao).format(
                  'DD/MM/YYYY HH:mm',
                )
                : ''
              }</td>
                                        <td class="text-secondary">${exame.estabelecimentoNome
              }</td>
                                    </tr>`;
          });
        ...
        if (hipoteseDiagnosticaFilter) {
          ...
          hipoteseDiagnosticaFilter.forEach((hipotese) => {
            hipoteseDiagnostica += `<tr class="text-left">
                                                    <td class="text-secondary">${hipotese.codigo
              }</td>
                                                    <td class="text-secondary">${hipotese.nome
              }</td>
                                                    <td class="text-secondary">${hipotese.cid_10
              }</td>
                                                    <td class="text-secondary">${hipotese.dataCriacao
                ? _moment(
        ...
        if (vacinasFilter) {
          ...
          vacinasFilter.forEach((vacina) => {
            vacinas += `<tr class="text-left">
                                        <td class="text-secondary">${vacina.nomeEstabelecimento
              }</td>
                                        <td class="text-secondary">${vacina.nomeProfissional
                ? vacina.nomeProfissional
                : ''
              }</td>
                                        <td class="text-secondary">${vacina.codigo
              }</td>
                                        <td class="text-secondary">${vacina.descricao
              }</td>
                                        <td class="text-secondary">${vacina.qtdPrescrita
              }</td>
                                        <td class="text-secondary">${vacina.qtdDispAnterior
              }</td>
                                        <td class="text-secondary">${vacina.dataUltDisp
                ? _moment(
                  vacina.dataUltDisp,
                ).format('DD/MM/YYYY HH:mm')
                : ''
        ...
        if (procedimentosFilter) {
          ...
          procedimentosFilter.forEach((procedimento) => {
            procedimentos += `<tr class="text-left">
                                                <td class="text-secondary">${procedimento.nomeFantasia
              }</td>
                                                <td class="text-secondary">${procedimento.nome
              }</td>
                                                <td class="text-secondary">${procedimento.co_procedimento
              }</td>
                                                <td class="text-secondary">${procedimento.no_procedimento
              }</td>
                                                <td class="text-secondary">${procedimento.dataCriacao
                ? _moment(
        ...
        if (encaminhamentosFilter) {
          ...
          encaminhamentosFilter.forEach((encaminhamento) => {
            encaminhamentos += `<tr class="text-left">
                                                <td class="text-secondary">${encaminhamento.nome
              }</td>
                                                <td class="text-secondary">${encaminhamento.motivo
              }</td>
                                                <td class="text-secondary">${encaminhamento.dataCriacao
                ? _moment(
        ...
        let conteudo = `
                            ...
                            <form class="container" id="form" style="font-size: 12px;">
                                ...
                                <div class="row">
                                    <div class="col s4" style="margin-top:20px;">
                                        <img style="width:60%; float:left; margin-left:10px;" src="${window.location.origin
                                ...
                                <div class="row">
                                    <div class="col s3">
                                        <span> Cartão SUS: ${result.paciente[0].cartaoSus
            ? result.paciente[0].cartaoSus
            : ''
          }</span>
                                    </div>
                                    <div class="col s3">
                                        <span> Id SAP: ${result.paciente[0].idSap
            ? result.paciente[0].idSap
            : ''
          }</span>
                                    </div>
                                    <div class="col s3">
                                        <span> Paciente: ${result.paciente[0].nome
            ? result.paciente[0].nome
            : ''
          }</span>
                                    </div>
                                    <div class="col s3">
                                        <span> Nome Social: ${result.paciente[0].nomeSocial
            ? result.paciente[0].nomeSocial
            : ''
          }</span>
                                    </div>
                                    <div class="col s3">
                                        <span> Apelido: ${result.paciente[0].apelido
            ? result.paciente[0].apelido
            : ''
          }</span>
                                    </div>
                                    <div class="col s3">
                                        <span> Nome da mãe: ${result.paciente[0].nomeMae
            ? result.paciente[0].nomeMae
            : ''
          }</span>
                                    </div>
                                    <div class="col s3">
                                        <span> Nome do pai: ${result.paciente[0].nomePai
            ? result.paciente[0].nomePai
            : ''
          }</span>
                                    </div>
                                    <div class="col s3">
                                        <span> Data de nascimento: ${result.paciente[0].dataNascimento
            ? result.paciente[0].dataNascimento
            : ''
          }</span>
                                    </div>
                                    <div class="col s3">
                                        <span> Sexo: ${result.paciente[0].sexo == 1
            ? 'Masculino'
            : 'Feminino'
          }</span>
                                    </div>
                                    <div class="col s3">
                                        <span> Nacionalidade: ${result.paciente[0].nacionalidadeNome
            ? result.paciente[0]
              .nacionalidadeNome
            : ''
          }</span>
                                    ...
                                    <div class="col s3">
                                        <span> Naturalidade: ${result.paciente[0].naturalidadeNome
            ? result.paciente[0]
              .naturalidadeNome
            : ''
          }</span>
                                    ...
                                    <div class="col s3">
                                        <span> CPF: ${result.paciente[0].cpf
            ? result.paciente[0].cpf
            : ''
          }</span>
                                    </div>
                                    <div class="col s3">
                                        <span> Ocupação: ${result.paciente[0].ocupacao
            ? result.paciente[0].ocupacao
            : ''
          }</span>
                                    </div>
                                    <div class="col s3">
                                        <span> Escolaridade: ${result.paciente[0].escolaridade
            ? result.paciente[0].escolaridade
            : ''
          }</span>
                                    </div>
                                    <div class="col s3">
                                        <span> Estabelecimento: ${result.estabelecimento.nomeFantasia
            ...
            : ''
                                    ...
                                    <div class="col s3">
                                        <span> Observações: ${result.paciente[0].observacao
            ? result.paciente[0].observacao
            : ''
          }</span>
                                    </div>
                                    <div class="col s3">
                                        <span> Falecido: ${result.paciente[0].falecido == 0
            ? 'Não'
            : 'Sim'
          }</span>
                                    </div>
                                    <div class="col s4">
                                        <span> Situação: ${result.paciente[0].situacao == 1
            ? 'Ativo'
            : 'Inativo'
          }</span>
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col s12">
                                        <span> História progressa/familiar: ${result.paciente[0]
  ...
  externalImprimir(
    ...
    this.pacienteLinkTemporarioService
      .obterProntuarioPacienteRelatorio(idPaciente, tipoFicha, profissional)
      .subscribe((result) => {
        console.log(result);
        let sinaisVitais = '';
